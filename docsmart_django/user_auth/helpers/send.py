...
class SendMail():
    ...
    def send_invite(self,current_user, invited_user,url):


        subject = 'Invitation: ' + current_user.first_name + ' ' + current_user.last_name + ' sent you an invite to join them on DocSmart'
    ...
    def send_confirmation_mail(self,user,url):
