...
class Customer(models.Model):
    ...
    reference = models.CharField(verbose_name="Reference", max_length=500, null=True)
    company_name = models.CharField(verbose_name="Company Name", max_length=500, null=True)
